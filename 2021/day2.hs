...
command (position, depth) (Forward amount) = (position + amount, depth)
command (position, depth) (Down amount) = (position, depth + amount)
command (position, depth) (Up amount) = (position, depth - amount)


command2 (position, depth, aim) (Forward amount) = (position + amount, depth + amount * aim, aim)
command2 (position, depth, aim) (Down amount) = (position, depth, aim + amount)
command2 (position, depth, aim) (Up amount) = (position, depth, aim - amount)
